	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'chalk':
				frames = Paths.getSparrowAtlas('chalk/chalk');
				animation.addByPrefix('idle', 'idle chalk', 24, false);
				animation.addByPrefix('singUP', 'chalk up', 24, false);
				animation.addByPrefix('singDOWN', 'chalk down', 24, false);
				animation.addByPrefix('singLEFT', 'chalk left', 24, false);
				animation.addByPrefix('singRIGHT', 'chalk right', 24, false);

				addOffset('idle');
				addOffset('singUP');
				addOffset('singDOWN', 0, -4);
				addOffset('singLEFT', 3, -4);
				addOffset('singRIGHT', 0, -4);

				playAnim('idle');
			case 'chalk-knife': 
				frames = Paths.getSparrowAtlas('chalk/chalk-knife');
				animation.addByPrefix('idle', 'chalk knife idle', 24, false);
				animation.addByPrefix('singUP', 'chalk knife up', 24, false);
				animation.addByPrefix('singDOWN', 'chalk knife down', 24, false); 
				animation.addByPrefix('singLEFT', 'chalk knife left', 24, false);
				animation.addByPrefix('singRIGHT', 'chalk knife right', 24, false);

				addOffset('idle');
				addOffset('singUP', 8, 17);
