...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('chalkyellowbg'));
		bg.scrollFactor.x = 0;
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('chalkmenuDesat'));
			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					...
					menuItems.forEach(function(spr:FlxSprite)
					{
						...
						{
							FlxTween.tween(spr, {alpha: 0, x: spr.x - 50}, 0.4, {
